...
public class QRCodeUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String text = "我的发哥";
        //不含Logo图片
        QRCodeUtil.encode(text, null, "F:\\wx", true);
        //含Logo图片，不指定二维码图片名
//        QRCodeUtil.encode(text, "C:\\Users\\David\\Pictures\\Camera Roll\\watermark.jpg", "F:\\wx", true);
        //含Logo图片，指定二维码图片名
//        QRCodeUtil.encode(text, "C:\\Users\\David\\Pictures\\Camera Roll\\watermark.jpg", "F:\\wx", "qrcodcicici", true);
    }
}
